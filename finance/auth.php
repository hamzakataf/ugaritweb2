...
$st2=1;
$user="USER";
$student_1=$database->prepare("SELECT * FROM student WHERE status3=:st2 AND ROLE=:USER ");
...
<head>
    ...
    <title>الطلبات الموافق عليها</title>
                                ...
                                <table class="table table-striped shadow rounded">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach($students as $student) { ?> 
                                            ...
                                            <td class="table-primary"><?php echo $student['PAYSTATUS']; ?></td>
                                            <td class="table-primary "><?php if($student['status3']==1){echo"مقبول";} ?> 
                                        </tr><?php } 
